...
<div class="main container">
    ...
    <div class="main-a row">
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 text-center">
            <p>
                <%--传入人数--%>
                <img src="images/453254312.png">${s}<br>
    ...
    <div class="main-c row">
        ...
        <ul class="list-unstyled text-center">
            ...
            <c:forEach items="${cs}" var="c" varStatus="st">
                <li class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                    <div>
                        <img src="images/${c.portrait}" width="130" height="130">
                        <span>${c.magor}:${c.name}</span>
                        <p class="text-left">${c.jianjie}</p>
                    </div>
                </li>
            </c:forEach>
        </ul>
    ...
    <div class="row main-bottom">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <ul class="logo">
                <li>
                    <a href=""><img src="images/123132.png"></a>
                </li>
                <li>
                    <a href=""> <img src="images/1549865.png"></a>
                </li>
                <li>
                    <a href=""> <img src="images/785345.png"></a>
                </li>
                <li>
                    <a href=""> <img src="images/1471.png"></a>
                </li>
                <li>
                    <a href=""> <img src="images/7861.png"></a>
                </li>
            </ul>
        </div>
    </div>
